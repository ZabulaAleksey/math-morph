...
Если global security review недоступен:

- выполни только Mathcad-specific дополнительные проверки;
- верни найденные findings;
- поставь итог `SECURITY_REVIEW_UNVERIFIED`;
- не объявляй обязательный security gate пройденным;
- не расширяй собственный scope в попытке заменить global reviewer.
