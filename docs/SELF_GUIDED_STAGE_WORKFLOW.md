...
- этапы 001–093, dependency-aware 095–099 и 143–148 имеют статус `verified`; независимый frontend-этап 154 также проверен;
- этап 094 заблокирован до versioned live MathType evidence; этапы 100–142 остаются planned;
- следующий CLI-инкремент — 149 (`inspect`), следующий frontend-инкремент — 155 (`design compliance checklist`);
