...
```text
Создай минимальный `docs/DESIGN.md`, не придумывая visual language. Если владелец продукта уже утвердил design contract, сохрани его и не заменяй заглушкой об отсутствии UI. Этот bootstrap-prompt не отменяет более поздние проектные решения.
```
