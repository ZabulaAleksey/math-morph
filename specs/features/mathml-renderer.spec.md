...
- comprehensive golden/snapshot suite этапа 091;
...
Расширение поддерживаемого AST и выбор `inline`/`block` как runtime option рассматриваются отдельным изменением SPEC после этапа 090.
