...
- Если семантика операции неизвестна, неоднозначна или не подтверждена compatibility contract,
  не заменяй её приблизительно похожей операцией.
- Сохрани Original AST/provenance, создай explicit unsupported diagnostic
  и останови вычисление этой семантики.
- Неизвестная математическая семантика не имеет эвристического production fallback.